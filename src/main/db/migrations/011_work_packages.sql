...
-- before the design below was corrected (see 013_work_package_rework.sql).
-- Never edit this file again — a later migration carries any database
-- forward from here, the same way 013 does; editing an applied migration
-- in place is exactly the bug 013 exists to fix.
-- =============================================================================
